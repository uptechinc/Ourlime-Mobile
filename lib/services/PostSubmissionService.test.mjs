...
const draft = () => ({ post: { userId: 'viewer', user: { id: 'viewer', firstName: 'Test', userName: 'test' }, type: 'regular', caption: 'Caption', description: '', visibility: 'public', media: [{ uri: 'file:///video.mp4', thumbnailUri: 'file:///cover.jpg', fileSize: 100, type: 'video', fileName: 'video.mp4' }], hashtags: ['test'], mentions: [], friendReferences: [] } });
